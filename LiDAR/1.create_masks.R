...
chm <- terra::rast("../../01_DATA/Mormal/LiDAR/2-las_utm/chm/chm.tif")

site_edges_path <- paste(data_dir, 
                         site, 
                         "Shape/shp_mormal_onf/foret_domaniale_mormal.shp", 
                         sep = "/")
site_edges_reprojected_bbox_path <- paste(data_dir, 
                                          site, 
...
lai_lidar <- terra::rast(file.path(results_path,
                                   "LiDAR/PAI/lidR/pai_las_cleaned.tif"))
# lai_lidar <- terra::rast(file.path(results_path,
#                                    "LiDAR/Profiles/PAD_2.5_46.69.tif"))
...
for (resolution in resolutions){
  ...
  # 20m
  if (resolution == 20){
    lai_s2 <- open_raster_file("/home/corroyez/Documents/NC_Full/03_RESULTS/Mormal/L2A_T31UER_A031222_20210614T105443/res_20m/PRO4SAIL_INVERSION_atbd/addmult/bands_3_4_8/L2A_T31UER_A031222_20210614T105443_Refl_lai.envi")
  }
  ...
  # errors <- list(standard_deviation_proj, coeff_variation, mean_heights, rumple)
